...
public class RandomAccessFile implements DataOutput, DataInput, java.io.Closeable {
    ...
    {
        this(name != null ? new java.io.File(name) : null, mode);
    }

    /**
     * Creates a random access file stream to read from, and optionally to
     * write to, the file specified by the {@link java.io.File} argument.  A new {@link
     ...
     * @exception java.io.IOException  if an I/O error occurs. Not thrown if
     ...
     */
    private native int readBytes(byte b[], int off, int len) throws java.io.IOException;
     ...
     * @exception java.io.IOException If the first byte cannot be read for any reason
     ...
     * @exception java.io.IOException If an I/O error has occurred.
     */
    private native void writeBytes(byte b[], int off, int len) throws java.io.IOException;
     ...
     *                   pointer.
     * @exception java.io.IOException  if {@code pos} is less than
    ...
    private native void seek0(long pos) throws java.io.IOException;
     ...
     * @since      1.2
     */
    public native void setLength(long newLength) throws java.io.IOException;
