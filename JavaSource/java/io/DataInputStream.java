 ...
 */
public
class DataInputStream extends FilterInputStream implements java.io.DataInput {
     ...
     * @exception java.io.IOException   the stream has been closed and the contained
     ...
     * @exception java.io.IOException  if the contained input stream does not support
     ...
     * @exception java.io.EOFException  if this input stream has reached the end.
     * @exception java.io.IOException   the stream has been closed and the contained
     *             input stream does not support reading after close, or
     *             another I/O error occurs.
     * @see        FilterInputStream#in
