...
public class PrintWriter extends java.io.Writer {
    ...
    private java.io.PrintStream psOut = null;
     ...
     *                    flush the output buffer
     *
     * @see java.io.OutputStreamWriter#OutputStreamWriter(OutputStream)
     */
    ...
    /* Private constructor */
    private PrintWriter(Charset charset, java.io.File file)
        throws FileNotFoundException
    {
    ...
    {
        this(toCharset(csn), new java.io.File(fileName));
    }
     ...
     * @since  1.5
     */
    public PrintWriter(java.io.File file) throws FileNotFoundException {
