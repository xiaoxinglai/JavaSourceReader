...
public class PipedReader extends Reader {
    ...
    */
     ...
     */
    public PipedReader(PipedWriter src) throws java.io.IOException {
     ...
     * available.
     */
    synchronized void receive(int c) throws java.io.IOException {
        if (!connected) {
     ...
     */
    synchronized void receive(char c[], int off, int len)  throws java.io.IOException {
        while (--len >= 0) {
            receive(c[off++]);
        }
    }
