...
public class ObjectOutputStream
    extends java.io.OutputStream implements java.io.ObjectOutput, ObjectStreamConstants
{
     ...
     */
    protected ObjectOutputStream() throws java.io.IOException, SecurityException {
     ...
     *          OutputStream.
     */
    public final void writeObject(Object obj) throws java.io.IOException {
        if (enableOverride) {
     ...
     * @throws java.io.IOException if there are I/O errors while writing to the
     *          underlying stream
     * @see #ObjectOutputStream()
     * @see #writeObject(Object)
     * @since 1.2
     */
    protected void writeObjectOverride(Object obj) throws java.io.IOException {
    }
     ...
     * @since 1.4
     */
    public void writeUnshared(Object obj) throws java.io.IOException {
        try {
     ...
     * called otherwise.
     *
     * @throws java.io.IOException if I/O errors occur while writing to the underlying
     *          <code>OutputStream</code>
     */
    public void defaultWriteObject() throws java.io.IOException {
        SerialCallbackContext ctx = curContext;
        if (ctx == null) {
            throw new java.io.NotActiveException("not in call to writeObject");
        }
        Object curObj = ctx.getObj();
        java.io.ObjectStreamClass curDesc = ctx.getDesc();
     ...
     * @since 1.2
     */
    public PutField putFields() throws java.io.IOException {
        if (curPut == null) {
            SerialCallbackContext ctx = curContext;
            if (ctx == null) {
                throw new java.io.NotActiveException("not in call to writeObject");
     ...
     * @throws java.io.IOException if I/O errors occur while writing to the underlying
     *          stream
     * @throws java.io.NotActiveException Called when a classes writeObject method was
    ...
    public void reset() throws java.io.IOException {
        if (depth != 0) {
            throw new java.io.IOException("stream active");
        }
        bout.setBlockDataMode(false);
    ...
    public static abstract class PutField {
         ...
         * @throws java.io.IOException if I/O errors occur while writing to the
         *         underlying stream
     ...
     */
    void writeTypeString(String str) throws java.io.IOException {
        int handle;
        if (str == null) {
            writeNull();
        ...
        throws java.io.IOException
    {
        ...
        try {
            ...
            if ((obj = subs.lookup(obj)) == null) {
                ...
                writeClassDesc((java.io.ObjectStreamClass) obj, unshared);
                return;
            }
            ...
            for (;;) {
                ...
                Class<?> repCl;
                desc = java.io.ObjectStreamClass.lookup(cl, true);
     ...
     */
    private void writeClass(Class<?> cl, boolean unshared) throws java.io.IOException {
        bout.writeByte(TC_CLASS);
        writeClassDesc(java.io.ObjectStreamClass.lookup(cl, true), false);
     ...
     */
    private void writeString(String str, boolean unshared) throws java.io.IOException {
        ...
        throws java.io.IOException
    {
        ...
        java.io.ObjectStreamClass sdesc = desc.getSuperDesc();
        ...
        throws java.io.IOException
    {
        ...
        try {
            ...
            if (desc.isExternalizable() && !desc.isProxy()) {
                writeExternalData((java.io.Externalizable) obj);
            } else {
     ...
     */
    private void writeExternalData(Externalizable obj) throws java.io.IOException {
     ...
     */
    private void writeSerialData(Object obj, java.io.ObjectStreamClass desc)
        throws java.io.IOException
    {
        java.io.ObjectStreamClass.ClassDataSlot[] slots = desc.getClassDataLayout();
        for (int i = 0; i < slots.length; i++) {
            java.io.ObjectStreamClass slotDesc = slots[i].desc;
     ...
     */
    private void defaultWriteFields(Object obj, java.io.ObjectStreamClass desc)
        throws java.io.IOException
    {
        Class<?> cl = desc.forClass();
        ...
        java.io.ObjectStreamField[] fields = desc.getFields(false);
    ...
    private class PutFieldImpl extends PutField {
        ...
        public void put(String name, boolean val) {
            java.io.Bits.putBoolean(primVals, getFieldOffset(name, Boolean.TYPE), val);
        }
        ...
        public void put(String name, char val) {
            java.io.Bits.putChar(primVals, getFieldOffset(name, Character.TYPE), val);
        }

        public void put(String name, short val) {
            java.io.Bits.putShort(primVals, getFieldOffset(name, Short.TYPE), val);
        }

        public void put(String name, int val) {
            java.io.Bits.putInt(primVals, getFieldOffset(name, Integer.TYPE), val);
        }

        public void put(String name, float val) {
            java.io.Bits.putFloat(primVals, getFieldOffset(name, Float.TYPE), val);
        }

        public void put(String name, long val) {
            java.io.Bits.putLong(primVals, getFieldOffset(name, Long.TYPE), val);
        }

        public void put(String name, double val) {
            java.io.Bits.putDouble(primVals, getFieldOffset(name, Double.TYPE), val);
        }
        ...
        public void write(ObjectOutput out) throws java.io.IOException {
            ...
            for (int i = 0; i < objVals.length; i++) {
                if (fields[numPrimFields + i].isUnshared()) {
                    throw new java.io.IOException("cannot write unshared object");
                }
        ...
        extends java.io.OutputStream implements DataOutput
    {
        ...
        private void writeBlockHeader(int len) throws java.io.IOException {
            if (len <= 0xFF) {
                ...
                java.io.Bits.putInt(hbuf, 1, len);
                out.write(hbuf, 0, 5);
            }
        }
        ...
        public void writeBoolean(boolean v) throws java.io.IOException {
            ...
            java.io.Bits.putBoolean(buf, pos++, v);
        }
        ...
        public void writeChar(int v) throws java.io.IOException {
            if (pos + 2 <= MAX_BLOCK_SIZE) {
                java.io.Bits.putChar(buf, pos, (char) v);
                pos += 2;
            } else {
                dout.writeChar(v);
            }
        ...
        public void writeShort(int v) throws java.io.IOException {
            if (pos + 2 <= MAX_BLOCK_SIZE) {
                java.io.Bits.putShort(buf, pos, (short) v);
                pos += 2;
            } else {
                dout.writeShort(v);
            }
        ...
        public void writeFloat(float v) throws java.io.IOException {
            if (pos + 4 <= MAX_BLOCK_SIZE) {
                java.io.Bits.putFloat(buf, pos, v);
                pos += 4;
            } else {
                dout.writeFloat(v);
            }
        ...
        public void writeLong(long v) throws java.io.IOException {
            if (pos + 8 <= MAX_BLOCK_SIZE) {
                java.io.Bits.putLong(buf, pos, v);
                pos += 8;
            } else {
                dout.writeLong(v);
            }
        ...
        public void writeDouble(double v) throws java.io.IOException {
            if (pos + 8 <= MAX_BLOCK_SIZE) {
                java.io.Bits.putDouble(buf, pos, v);
                pos += 8;
            } else {
                dout.writeDouble(v);
            }
        ...
        void writeBooleans(boolean[] v, int off, int len) throws java.io.IOException {
            ...
            while (off < endoff) {
                ...
                while (off < stop) {
                    java.io.Bits.putBoolean(buf, pos++, v[off++]);
                }
            }
        }
        ...
        void writeChars(char[] v, int off, int len) throws java.io.IOException {
            ...
            while (off < endoff) {
                if (pos <= limit) {
                    ...
                    while (off < stop) {
                        java.io.Bits.putChar(buf, pos, v[off++]);
                        pos += 2;
                    }
                } else {
        ...
        void writeShorts(short[] v, int off, int len) throws java.io.IOException {
            ...
            while (off < endoff) {
                if (pos <= limit) {
                    ...
                    int stop = Math.min(endoff, off + avail);
                    while (off < stop) {
                        java.io.Bits.putShort(buf, pos, v[off++]);
                        pos += 2;
                    }
                } else {
        ...
        void writeInts(int[] v, int off, int len) throws java.io.IOException {
            ...
            while (off < endoff) {
                if (pos <= limit) {
                    ...
                    int stop = Math.min(endoff, off + avail);
                    while (off < stop) {
                        java.io.Bits.putInt(buf, pos, v[off++]);
                        pos += 4;
                    }
                } else {
                    dout.writeInt(v[off++]);
        ...
        void writeLongs(long[] v, int off, int len) throws java.io.IOException {
            ...
            while (off < endoff) {
                if (pos <= limit) {
                    ...
                    int stop = Math.min(endoff, off + avail);
                    while (off < stop) {
                        java.io.Bits.putLong(buf, pos, v[off++]);
                        pos += 8;
                    }
                } else {
         ...
         */
        void writeUTF(String s, long utflen) throws java.io.IOException {
            if (utflen > 0xFFFFL) {
         ...
         */
        void writeLongUTF(String s) throws java.io.IOException {
         ...
         */
        void writeLongUTF(String s, long utflen) throws java.io.IOException {
            writeLong(utflen);
            if (utflen == (long) s.length()) {
                writeBytes(s);
            } else {
