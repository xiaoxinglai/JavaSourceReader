...
class FileOutputStream extends OutputStream
{
    ...
    public FileOutputStream(String name) throws FileNotFoundException {
        this(name != null ? new java.io.File(name) : null, false);
    }
    ...
    {
        this(name != null ? new java.io.File(name) : null, append);
    }
     ...
     */
    private native void write(int b, boolean append) throws java.io.IOException;
