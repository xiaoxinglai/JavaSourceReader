...
public class BufferedReader extends java.io.Reader {
     ...
     * stream if necessary.
     */
    private int read1(char[] cbuf, int off, int len) throws java.io.IOException {
        if (nextChar >= nChars) {
     ...
     * @exception java.io.IOException  If an I/O error occurs
     */
    String readLine(boolean ignoreLF) throws java.io.IOException {
        StringBuffer s = null;
        int startChar;
    ...
    public void reset() throws java.io.IOException {
        synchronized (lock) {
            ensureOpen();
            if (markedChar < 0)
                throw new java.io.IOException((markedChar == INVALIDATED)
                                      ? "Mark invalid"
                                      : "Stream not marked");
            nextChar = markedChar;
            skipLF = markedSkipLF;
