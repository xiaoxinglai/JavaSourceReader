...
public class PipedWriter extends Writer {
     ...
     */
    public PipedWriter(java.io.PipedReader snk)  throws java.io.IOException {
        connect(snk);
    }
     ...
     * @exception java.io.IOException  if an I/O error occurs.
     */
    public synchronized void connect(PipedReader snk) throws java.io.IOException {
        if (snk == null) {
     ...
     *
     * @exception java.io.IOException  if the pipe is closed, or an I/O error occurs.
     */
