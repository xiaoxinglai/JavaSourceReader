    ...
    extends java.io.InputStream implements ObjectInput, ObjectStreamConstants
{
     ...
     */
    protected ObjectInputStream() throws java.io.IOException, SecurityException {
     ...
     * @since   1.4
     */
    public Object readUnshared() throws java.io.IOException, ClassNotFoundException {
        // if nested read, passHandle contains handle of enclosing object
        int outerHandle = passHandle;
        try {
    ...
    protected void readStreamHeader()
        throws java.io.IOException, StreamCorruptedException
    {
    ...
    public static abstract class GetField {
         ...
         */
        public abstract boolean defaulted(String name) throws java.io.IOException;
         ...
         *         not serializable or if the field type is incorrect
         */
        public abstract byte get(String name, byte val) throws java.io.IOException;
         ...
         *         not serializable or if the field type is incorrect
         */
        public abstract char get(String name, char val) throws java.io.IOException;
         ...
         *         not serializable or if the field type is incorrect
         */
        public abstract short get(String name, short val) throws java.io.IOException;
         ...
         *         not serializable or if the field type is incorrect
         */
        public abstract int get(String name, int val) throws java.io.IOException;
         ...
         *         not serializable or if the field type is incorrect
         */
        public abstract long get(String name, long val) throws java.io.IOException;
         ...
         *         not serializable or if the field type is incorrect
         */
        public abstract float get(String name, float val) throws java.io.IOException;
         ...
         *         not serializable or if the field type is incorrect
         */
        public abstract double get(String name, double val) throws java.io.IOException;
         ...
         *         not serializable or if the field type is incorrect
         */
        public abstract Object get(String name, Object val) throws java.io.IOException;
    }
     ...
     */
    private Object readObject0(boolean unshared) throws java.io.IOException {
        ...
        try {
            switch (tc) {
                ...
                case TC_EXCEPTION:
                    java.io.IOException ex = readFatalException();
     ...
     */
    private Object checkResolve(Object obj) throws java.io.IOException {
     ...
     */
    String readTypeString() throws java.io.IOException {
     ...
     */
    private Object readNull() throws java.io.IOException {
     ...
     */
    private Object readHandle(boolean unshared) throws java.io.IOException {
     ...
     * handle table).
     */
    private Class<?> readClass(boolean unshared) throws java.io.IOException {
        ...
        throws java.io.IOException
    {
        ...
        try {
            ...
            throw (java.io.IOException) new InvalidClassException(
     ...
     * assigned handle.
     */
    private String readString(boolean unshared) throws java.io.IOException {
        String str;
     ...
     */
    private Object readArray(boolean unshared) throws java.io.IOException {
     ...
     */
    private Enum<?> readEnum(boolean unshared) throws java.io.IOException {
        ...
        if (cl != null) {
            try {
                ...
                throw (java.io.IOException) new InvalidObjectException(
        ...
        throws java.io.IOException
    {
        ...
        if (desc.isExternalizable()) {
            readExternalData((java.io.Externalizable) obj, desc);
        } else {
    ...
    private java.io.IOException readFatalException() throws java.io.IOException {
        ...
        clear();
        return (java.io.IOException) readObject0(false);
    }
    ...
    private class GetFieldImpl extends GetField {
        ...
        public boolean defaulted(String name) throws java.io.IOException {
            return (getFieldOffset(name, null) < 0);
        }

        public boolean get(String name, boolean val) throws java.io.IOException {
            int off = getFieldOffset(name, Boolean.TYPE);
            return (off >= 0) ? java.io.Bits.getBoolean(primVals, off) : val;
        }

        public byte get(String name, byte val) throws java.io.IOException {
            int off = getFieldOffset(name, Byte.TYPE);
            return (off >= 0) ? primVals[off] : val;
        }

        public char get(String name, char val) throws java.io.IOException {
            int off = getFieldOffset(name, Character.TYPE);
            return (off >= 0) ? java.io.Bits.getChar(primVals, off) : val;
        }

        public short get(String name, short val) throws java.io.IOException {
            int off = getFieldOffset(name, Short.TYPE);
            return (off >= 0) ? java.io.Bits.getShort(primVals, off) : val;
        }

        public int get(String name, int val) throws java.io.IOException {
            int off = getFieldOffset(name, Integer.TYPE);
            return (off >= 0) ? java.io.Bits.getInt(primVals, off) : val;
        }

        public float get(String name, float val) throws java.io.IOException {
            int off = getFieldOffset(name, Float.TYPE);
            return (off >= 0) ? java.io.Bits.getFloat(primVals, off) : val;
        }

        public long get(String name, long val) throws java.io.IOException {
            int off = getFieldOffset(name, Long.TYPE);
            return (off >= 0) ? java.io.Bits.getLong(primVals, off) : val;
        }

        public double get(String name, double val) throws java.io.IOException {
            int off = getFieldOffset(name, Double.TYPE);
            return (off >= 0) ? java.io.Bits.getDouble(primVals, off) : val;
        }

        public Object get(String name, Object val) throws java.io.IOException {
        ...
        extends java.io.InputStream implements DataInput
    {
         ...
         */
        String readLongUTF() throws java.io.IOException {
         ...
         * utflen bytes.
         */
        private String readUTFBody(long utflen) throws java.io.IOException {
