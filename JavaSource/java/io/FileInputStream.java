...
class FileInputStream extends InputStream
{
    ...
    public FileInputStream(String name) throws FileNotFoundException {
        this(name != null ? new java.io.File(name) : null);
    }
     ...
     * @exception java.io.IOException  if n is negative, if the stream does not
     *             support seek, or if an I/O error occurs.
     */
    public native long skip(long n) throws java.io.IOException;
     ...
     * @exception java.io.IOException  if this file input stream has been closed by calling
