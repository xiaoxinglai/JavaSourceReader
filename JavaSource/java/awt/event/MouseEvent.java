 ...
 * The state of modal keys can be retrieved using {@link java.awt.event.InputEvent#getModifiers}
 * and {@link java.awt.event.InputEvent#getModifiersEx}.
 * The button mask returned by {@link java.awt.event.InputEvent#getModifiers} reflects
 ...
 * {@link java.awt.event.InputEvent#getModifiersEx}.
 ...
 * {@link java.awt.event.InputEvent#getMaskForButton(int) getMaskForButton(button)} method may be used
 * as button masks.
 * <p>
   ...
   */
    ...
    public int getModifiersEx() {
        ...
        if (shouldExcludeButtonFromExtModifiers) {
            tmpModifiers &= ~(java.awt.event.InputEvent.getMaskForButton(getButton()));
        }
     ...
     * @see java.awt.event.InputEvent#getMaskForButton(int)
     * @since 1.6
     */
    public MouseEvent(Component source, int id, long when, int modifiers,
     ...
     * @see java.awt.event.InputEvent#getModifiersExText(int)
     * @since 1.4
     */
