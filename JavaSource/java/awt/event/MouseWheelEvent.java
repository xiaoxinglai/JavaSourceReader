...
public class MouseWheelEvent extends java.awt.event.MouseEvent {
     ...
     * @see java.awt.event.MouseEvent#MouseEvent(Component, int, long, int, int, int, int, boolean)
     * @see java.awt.event.MouseEvent#MouseEvent(Component, int, long, int, int, int, int, int, int, boolean, int)
     */
