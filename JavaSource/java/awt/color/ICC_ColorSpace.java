...
public class ICC_ColorSpace extends java.awt.color.ColorSpace {
    ...
    */
    public ICC_ColorSpace (java.awt.color.ICC_Profile profile) {
        ...
        if ((profileClass != java.awt.color.ICC_Profile.CLASS_INPUT) &&
            (profileClass != java.awt.color.ICC_Profile.CLASS_DISPLAY) &&
            (profileClass != java.awt.color.ICC_Profile.CLASS_OUTPUT) &&
            (profileClass != java.awt.color.ICC_Profile.CLASS_COLORSPACECONVERSION) &&
            (profileClass != java.awt.color.ICC_Profile.CLASS_NAMEDCOLOR) &&
            (profileClass != java.awt.color.ICC_Profile.CLASS_ABSTRACT)) {
    ...
    */
    ...
    public float[]    toRGB (float[] colorvalue) {
        ...
        if (this2srgb == null) {
            ...
            ICC_ColorSpace srgbCS =
                (ICC_ColorSpace) java.awt.color.ColorSpace.getInstance (CS_sRGB);
    ...
    public float[]    toCIEXYZ(float[] colorvalue) {
        ...
        if (this2xyz == null) {
            ...
            ICC_ColorSpace xyzCS =
                (ICC_ColorSpace) java.awt.color.ColorSpace.getInstance (CS_CIEXYZ);
            PCMM mdl = CMSManager.getModule();
            try {
                transformList[0] = mdl.createTransform(
                    thisProfile, java.awt.color.ICC_Profile.icRelativeColorimetric,
                    ColorTransform.In);
    ...
    private void setMinMax() {
        ...
        minVal = new float[nc];
        maxVal = new float[nc];
        if (type == java.awt.color.ColorSpace.TYPE_Lab) {
            minVal[0] = 0.0f;    // L
            maxVal[0] = 100.0f;
            minVal[1] = -128.0f; // a
            maxVal[1] = 127.0f;
