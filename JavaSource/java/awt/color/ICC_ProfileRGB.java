...
extends java.awt.color.ICC_Profile {
    ...
    public float[][] getMatrix() {
        ...
        tmpMatrix = getXYZTag(java.awt.color.ICC_Profile.icSigRedColorantTag);
        theMatrix[0][0] = tmpMatrix[0];
        theMatrix[1][0] = tmpMatrix[1];
        theMatrix[2][0] = tmpMatrix[2];
        tmpMatrix = getXYZTag(java.awt.color.ICC_Profile.icSigGreenColorantTag);
        theMatrix[0][1] = tmpMatrix[0];
        theMatrix[1][1] = tmpMatrix[1];
        theMatrix[2][1] = tmpMatrix[2];
        tmpMatrix = getXYZTag(java.awt.color.ICC_Profile.icSigBlueColorantTag);
    ...
    int theSignature;
        ...
        switch (component) {
        case REDCOMPONENT:
            theSignature = java.awt.color.ICC_Profile.icSigRedTRCTag;
            break;

        case GREENCOMPONENT:
            theSignature = java.awt.color.ICC_Profile.icSigGreenTRCTag;
            break;

        case BLUECOMPONENT:
            theSignature = java.awt.color.ICC_Profile.icSigBlueTRCTag;
            break;
