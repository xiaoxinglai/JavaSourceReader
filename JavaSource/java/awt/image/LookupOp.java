...
public class LookupOp implements BufferedImageOp, RasterOp {
     ...
     *
     */
    public final WritableRaster filter (java.awt.image.Raster src, WritableRaster dst) {
    ...
    public BufferedImage createCompatibleDestImage (BufferedImage src,
        ...
        if (destCM == null) {
            ...
            java.awt.image.Raster raster = src.getRaster();
    ...
    private final void byteFilter(ByteLookupTable lookup, java.awt.image.Raster src,
                                  WritableRaster dst,
