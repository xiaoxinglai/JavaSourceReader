 ...
 *  {@link java.awt.image.DataBuffer#TYPE_BYTE TYPE_BYTE},
 *  {@link java.awt.image.DataBuffer#TYPE_USHORT TYPE_USHORT},
 *  {@link java.awt.image.DataBuffer#TYPE_SHORT TYPE_SHORT},
 *  {@link java.awt.image.DataBuffer#TYPE_INT TYPE_INT},
 *  {@link java.awt.image.DataBuffer#TYPE_FLOAT TYPE_FLOAT},
 *  {@link java.awt.image.DataBuffer#TYPE_DOUBLE TYPE_DOUBLE},
...
public class ComponentSampleModel extends java.awt.image.SampleModel
{
    ...
    public java.awt.image.SampleModel createCompatibleSampleModel(int w, int h) {
        java.awt.image.SampleModel ret=null;
        long size;
    ...
    public final int getSampleSize(int band) {
        return java.awt.image.DataBuffer.getDataTypeSize(dataType);
    }
     ...
     * with the
     * {@link #getDataElements(int, int, Object, java.awt.image.DataBuffer) } and
     * {@link #setDataElements(int, int, Object, java.awt.image.DataBuffer) }
     * methods.
     ...
     */
    public Object getDataElements(int x, int y, Object obj, java.awt.image.DataBuffer data) {
     ...
     */
    public void setDataElements(int x, int y, Object obj, java.awt.image.DataBuffer data) {
        if ((x < 0) || (y < 0) || (x >= width) || (y >= height)) {
            throw new ArrayIndexOutOfBoundsException
                ("Coordinate out of bounds!");
        }
