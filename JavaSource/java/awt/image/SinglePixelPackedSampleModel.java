 ...
 *  {@link java.awt.image.DataBuffer#TYPE_INT TYPE_INT} data types.
...
public class SinglePixelPackedSampleModel extends java.awt.image.SampleModel
{
    ...
    public SinglePixelPackedSampleModel(int dataType, int w, int h,
        ...
        int maxMask = (int)((1L << java.awt.image.DataBuffer.getDataTypeSize(dataType)) - 1);
    ...
    public java.awt.image.SampleModel createCompatibleSampleModel(int w, int h) {
      java.awt.image.SampleModel sampleModel = new SinglePixelPackedSampleModel(dataType, w, h,
                                                              bitMasks);
      return sampleModel;
    }
     ...
     * @exception java.awt.image.RasterFormatException if the length of the bands argument is
