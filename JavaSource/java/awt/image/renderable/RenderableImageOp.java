...
package JavaSource.java.awt.image.renderable;
...
public class RenderableImageOp implements java.awt.image.renderable.RenderableImage {
    ...
    public RenderableImageOp(ContextualRenderedImageFactory CRIF,
                             java.awt.image.renderable.ParameterBlock paramBlock) {
        this.myCRIF = CRIF;
        this.paramBlock = (java.awt.image.renderable.ParameterBlock) paramBlock.clone();
    }
     ...
     */
    public Vector<java.awt.image.renderable.RenderableImage> getSources() {
    ...
    private Vector getRenderableSources() {
        ...
        if (paramBlock.getNumSources() > 0) {
            ...
            while (i < paramBlock.getNumSources()) {
                ...
                if (o instanceof java.awt.image.renderable.RenderableImage) {
                    sources.add((java.awt.image.renderable.RenderableImage)o);
                    i++;
                } else {
                    break;
                }
    ...
    public java.awt.image.renderable.ParameterBlock setParameterBlock(java.awt.image.renderable.ParameterBlock paramBlock) {
        java.awt.image.renderable.ParameterBlock oldParamBlock = this.paramBlock;
        this.paramBlock = (java.awt.image.renderable.ParameterBlock)paramBlock.clone();
     ...
     * @see #setParameterBlock(java.awt.image.renderable.ParameterBlock)
     */
    ...
    public RenderedImage createScaledRendering(int w, int h,
        ...
        java.awt.image.renderable.RenderContext newRC = new java.awt.image.renderable.RenderContext(usr2dev, hints);
    ...
    public RenderedImage createDefaultRendering() {
        ...
        java.awt.image.renderable.RenderContext newRC = new java.awt.image.renderable.RenderContext(usr2dev);
        return createRendering(newRC);
    }
     ...
     */
    public RenderedImage createRendering(java.awt.image.renderable.RenderContext renderContext) {
        ...
        // RenderedImages.
        java.awt.image.renderable.ParameterBlock renderedParamBlock = (ParameterBlock)paramBlock.clone();
