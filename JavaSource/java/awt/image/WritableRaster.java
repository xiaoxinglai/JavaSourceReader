...
public class WritableRaster extends java.awt.image.Raster {
     ...
     *          in integer overflow
     */
    protected WritableRaster(java.awt.image.SampleModel sampleModel,
                             Point origin) {
        this(sampleModel,
     ...
     * @see SampleModel#setDataElements(int, int, Object, java.awt.image.DataBuffer)
     ...
     * in bounds.
     */
    public void setDataElements(int x, int y, java.awt.image.Raster inRaster) {
     ...
     * A ClassCastException will be thrown if the input object is not null
     * and references anything other than an array of TransferType.
     * @see SampleModel#setDataElements(int, int, int, int, Object, java.awt.image.DataBuffer)
     ...
     * {@link WritableRaster#setRect(java.awt.image.Raster)}.
     *
