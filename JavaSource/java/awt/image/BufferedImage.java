 ...
 * A <code>BufferedImage</code> is comprised of a {@link java.awt.image.ColorModel} and a
 * {@link java.awt.image.Raster} of image data.
 * The number and types of bands in the {@link java.awt.image.SampleModel} of the
        ...
        case TYPE_BYTE_BINARY:
            {
                ...
                raster = java.awt.image.Raster.createPackedRaster(java.awt.image.DataBuffer.TYPE_BYTE,
 ...
 *
 */
    public BufferedImage (java.awt.image.ColorModel cm,
                          WritableRaster raster,
    ...
    private static boolean isStandard(java.awt.image.ColorModel cm, WritableRaster wr) {
        final Class<? extends java.awt.image.ColorModel> cmClass = cm.getClass();
        final Class<? extends WritableRaster> wrClass = wr.getClass();
        final Class<? extends java.awt.image.SampleModel> smClass = wr.getSampleModel().getClass();
     ...
     * @see #setData(java.awt.image.Raster)
     */
    public java.awt.image.Raster getData() {
        ...
        WritableRaster wr =
           java.awt.image.Raster.createWritableRaster(raster.getSampleModel(),
     ...
     * @see #setData(java.awt.image.Raster)
     */
    public java.awt.image.Raster getData(Rectangle rect) {
        java.awt.image.SampleModel sm = raster.getSampleModel();
        SampleModel nsm = sm.createCompatibleSampleModel(rect.width,
                                                         rect.height);
        WritableRaster wr = java.awt.image.Raster.createWritableRaster(nsm,
                                                  rect.getLocation());
   ...
   * @param to the specified {@link java.awt.image.TileObserver}
   */
