...
public class IndexColorModel extends java.awt.image.ColorModel {
    ...
    public IndexColorModel(int bits, int size,
        ...
        if ((transferType != java.awt.image.DataBuffer.TYPE_BYTE) &&
            (transferType != java.awt.image.DataBuffer.TYPE_USHORT)) {
     ...
     * @see java.awt.image.ColorModel#hasAlpha
     * @see java.awt.image.ColorModel#getNumComponents
     */
    ...
    public java.awt.image.WritableRaster createCompatibleWritableRaster(int w, int h) {
        ...
        if (pixel_bits == 1 || pixel_bits == 2 || pixel_bits == 4) {
            ...
            raster = java.awt.image.Raster.createInterleavedRaster(java.awt.image.DataBuffer.TYPE_USHORT,
                                                  w,h,1,null);
        }
        else {
            throw new
     ...
     */
    public java.awt.image.BufferedImage convertToIntDiscrete(Raster raster,
                                                             boolean forceARGB) {
