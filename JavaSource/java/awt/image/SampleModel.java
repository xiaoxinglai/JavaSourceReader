...
package JavaSource.java.awt.image;
...
public abstract class SampleModel
{
    ...
    public SampleModel(int dataType, int w, int h, int numBands)
    {
        ...
        if (dataType < java.awt.image.DataBuffer.TYPE_BYTE ||
            (dataType > java.awt.image.DataBuffer.TYPE_DOUBLE &&
             dataType != java.awt.image.DataBuffer.TYPE_UNDEFINED))
        {
     ...
     *  @see #getDataElements(int, int, Object, java.awt.image.DataBuffer)
     *  @see #getDataElements(int, int, int, int, Object, java.awt.image.DataBuffer)
     *  @see #setDataElements(int, int, Object, java.awt.image.DataBuffer)
     *  @see #setDataElements(int, int, int, int, Object, java.awt.image.DataBuffer)
     *  @see #getTransferType
     */
     ...
     * @see #setPixel(int, int, int[], java.awt.image.DataBuffer)
     *
    ...
    public abstract Object getDataElements(int x, int y,
                                           Object obj, java.awt.image.DataBuffer data);
     ...
     * @param data      The DataBuffer containing the image data.
     * @return the samples for the specified pixel.
     * @see #setPixel(int, int, float[], java.awt.image.DataBuffer)
     *
     * @throws NullPointerException if data is null.
     * @throws ArrayIndexOutOfBoundsException if the coordinates are
     ...
     * @param data      The DataBuffer containing the image data.
     * @return the samples for the specified pixel.
     * @see #setPixel(int, int, double[], java.awt.image.DataBuffer)
     *
     * @throws NullPointerException if data is null.
     * @throws ArrayIndexOutOfBoundsException if the coordinates are
     ...
     * @see #setPixels(int, int, int, int, int[], java.awt.image.DataBuffer)
     *
     * @throws NullPointerException if data is null.
     * @throws ArrayIndexOutOfBoundsException if the coordinates are
     * not in bounds, or if iArray is too small to hold the output.
    ...
    public int[] getPixels(int x, int y, int w, int h,
                           int iArray[], java.awt.image.DataBuffer data) {
     ...
     * @param data      The DataBuffer containing the image data.
     * @return the samples for the specified region of pixels.
     * @see #setPixels(int, int, int, int, float[], java.awt.image.DataBuffer)
     *
     * @throws NullPointerException if data is null.
     * @throws ArrayIndexOutOfBoundsException if the coordinates are
     * not in bounds, or if fArray is too small to hold the output.
    ...
    public float[] getPixels(int x, int y, int w, int h,
                             float fArray[], java.awt.image.DataBuffer data) {
     ...
     * @param data      The DataBuffer containing the image data.
     * @return the samples for the specified region of pixels.
     * @see #setPixels(int, int, int, int, double[], java.awt.image.DataBuffer)
     *
     * @throws NullPointerException if data is null.
     * @throws ArrayIndexOutOfBoundsException if the coordinates are
     * not in bounds, or if dArray is too small to hold the output.
    ...
    public double[] getPixels(int x, int y, int w, int h,
                              double dArray[], java.awt.image.DataBuffer data) {
        double pixels[];
        int    Offset = 0;
        int x1 = x + w;
        int y1 = y + h;
     ...
     * @see #setSample(int, int, int, int, java.awt.image.DataBuffer)
     *
     * @throws NullPointerException if data is null.
     * @throws ArrayIndexOutOfBoundsException if the coordinates or
     * the band index are not in bounds.
     */
    public abstract int getSample(int x, int y, int b, java.awt.image.DataBuffer data);
     ...
     *         of pixels.
     * @see #setSamples(int, int, int, int, int, int[], java.awt.image.DataBuffer)
     *
     * @throws NullPointerException if data is null.
     * @throws ArrayIndexOutOfBoundsException if the coordinates or
     ...
     * @return the samples for the specified band for the specified region
     *         of pixels.
     * @see #setSamples(int, int, int, int, int, float[], java.awt.image.DataBuffer)
     *
     * @throws NullPointerException if data is null.
     * @throws ArrayIndexOutOfBoundsException if the coordinates or
     ...
     * @return the samples for the specified band for the specified region
     *         of pixels.
     * @see #setSamples(int, int, int, int, int, double[], java.awt.image.DataBuffer)
     *
     * @throws NullPointerException if data is null.
     * @throws ArrayIndexOutOfBoundsException if the coordinates or
     ...
     * @param data      The DataBuffer containing the image data.
     * @see #getPixel(int, int, int[], java.awt.image.DataBuffer)
     *
     ...
     * @param data      The DataBuffer containing the image data.
     * @see #getPixel(int, int, float[], java.awt.image.DataBuffer)
     *
     ...
     * @param data      The DataBuffer containing the image data.
     * @see #getPixel(int, int, double[], java.awt.image.DataBuffer)
     *
     ...
     * @param iArray    The input samples in an int array.
     * @param data      The DataBuffer containing the image data.
     * @see #getPixels(int, int, int, int, int[], java.awt.image.DataBuffer)
     *
     * @throws NullPointerException if iArray or data is null.
     * @throws ArrayIndexOutOfBoundsException if the coordinates are
     * not in bounds, or if iArray is too small to hold the input.
     ...
     * @param fArray    The input samples in a float array.
     * @param data      The DataBuffer containing the image data.
     * @see #getPixels(int, int, int, int, float[], java.awt.image.DataBuffer)
     *
     * @throws NullPointerException if fArray or data is null.
     * @throws ArrayIndexOutOfBoundsException if the coordinates are
     * not in bounds, or if fArray is too small to hold the input.
     ...
     * @param dArray    The input samples in a double array.
     * @param data      The DataBuffer containing the image data.
     * @see #getPixels(int, int, int, int, double[], java.awt.image.DataBuffer)
     *
     * @throws NullPointerException if dArray or data is null.
     * @throws ArrayIndexOutOfBoundsException if the coordinates are
     ...
     * @param data      The DataBuffer containing the image data.
     * @see #getSample(int, int, int, java.awt.image.DataBuffer)
     *
     * @throws NullPointerException if data is null.
     * @throws ArrayIndexOutOfBoundsException if the coordinates or
     * the band index are not in bounds.
     ...
     * @param iArray    The input samples in an int array.
     * @param data      The DataBuffer containing the image data.
     * @see #getSamples(int, int, int, int, int, int[], java.awt.image.DataBuffer)
     *
     * @throws NullPointerException if iArray or data is null.
     * @throws ArrayIndexOutOfBoundsException if the coordinates or
     * the band index are not in bounds, or if iArray is too small to
     ...
     * @param fArray    The input samples in a float array.
     * @param data      The DataBuffer containing the image data.
     * @see #getSamples(int, int, int, int, int, float[], java.awt.image.DataBuffer)
     *
     * @throws NullPointerException if fArray or data is null.
     * @throws ArrayIndexOutOfBoundsException if the coordinates or
     * the band index are not in bounds, or if fArray is too small to
     ...
     * @param dArray    The input samples in a double array.
     * @param data      The DataBuffer containing the image data.
     * @see #getSamples(int, int, int, int, int, double[], java.awt.image.DataBuffer)
     *
     * @throws NullPointerException if dArray or data is null.
     * @throws ArrayIndexOutOfBoundsException if the coordinates or
     * the band index are not in bounds, or if dArray is too small to
