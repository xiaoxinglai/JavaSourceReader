...
public class ColorConvertOp implements BufferedImageOp, RasterOp {
     ...
     * when the {@link #filter(java.awt.image.BufferedImage, java.awt.image.BufferedImage) filter}
     ...
     */
    public final java.awt.image.BufferedImage filter(java.awt.image.BufferedImage src, java.awt.image.BufferedImage dest) {
        ColorSpace srcColorSpace, destColorSpace;
        java.awt.image.BufferedImage savdest = null;
    ...
    private final java.awt.image.BufferedImage ICCBIFilter(java.awt.image.BufferedImage src,
     ...
     */
    public final WritableRaster filter (java.awt.image.Raster src, WritableRaster dest)  {
        ...
        if ((srcTransferType == java.awt.image.DataBuffer.TYPE_FLOAT) ||
            (srcTransferType == java.awt.image.DataBuffer.TYPE_DOUBLE) ||
            (dstTransferType == java.awt.image.DataBuffer.TYPE_FLOAT) ||
            (dstTransferType == java.awt.image.DataBuffer.TYPE_DOUBLE)) {
            if (srcMinVals == null) {
     ...
     */
    public final Rectangle2D getBounds2D (java.awt.image.BufferedImage src) {
     ...
     *         of the destination, given the specified <code>src</code>
     */
    public final Rectangle2D getBounds2D (java.awt.image.Raster src) {
    ...
    private java.awt.image.BufferedImage createCompatibleDestImage(java.awt.image.BufferedImage src,
                                                                   java.awt.image.ColorModel destCM,
                                                                   ColorSpace destCS) {
        java.awt.image.BufferedImage image;
        if (destCM == null) {
            java.awt.image.ColorModel srcCM = src.getColorModel();
        ...
        int w = src.getWidth();
        int h = src.getHeight();
        image = new java.awt.image.BufferedImage(destCM,
     ...
     */
    public WritableRaster createCompatibleDestRaster (java.awt.image.Raster src) {
        int ncomponents;
        ...
        WritableRaster dest =
            java.awt.image.Raster.createInterleavedRaster(java.awt.image.DataBuffer.TYPE_BYTE,
                                  src.getWidth(),
                                  src.getHeight(),
                                  ncomponents,
    ...
    private final java.awt.image.BufferedImage nonICCBIFilter(java.awt.image.BufferedImage src,
                                                              ColorSpace srcColorSpace,
                                                              BufferedImage dst,
        ...
        java.awt.image.Raster srcRas = src.getRaster();
    ...
    private final WritableRaster nonICCRasterFilter(Raster src,
        ...
        java.awt.image.SampleModel srcSM = src.getSampleModel();
        ...
        if ((dstTransferType == java.awt.image.DataBuffer.TYPE_FLOAT) ||
            (dstTransferType == java.awt.image.DataBuffer.TYPE_DOUBLE)) {
            dstIsFloat = true;
        } else {
            dstIsFloat = false;
        ...
        if (!srcIsFloat) {
            ...
            for (int i = 0; i < srcNumBands; i++) {
                if (srcTransferType == java.awt.image.DataBuffer.TYPE_SHORT) {
