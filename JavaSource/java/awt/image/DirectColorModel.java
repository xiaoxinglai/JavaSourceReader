 ...
 * construct a {@link java.awt.image.BufferedImage}.  Normally the masks used by the
 * {@link java.awt.image.SampleModel} and the <code>ColorModel</code> would be the
 ...
 * {@link java.awt.image.ColorModel#getRGBdefault() getRGBdefault} method is a
...
public class DirectColorModel extends PackedColorModel {
    ...
    public DirectColorModel(int bits, int rmask, int gmask,
        ...
        super (ColorSpace.getInstance(ColorSpace.CS_sRGB),
               ...
               java.awt.image.ColorModel.getDefaultTransferType(bits));
        setFields();
    }
    ...
    public DirectColorModel(ColorSpace space, int bits, int rmask,
        ...
        super (space, bits, rmask, gmask, bmask, amask,
               ...
               amask == 0 ? Transparency.OPAQUE : Transparency.TRANSLUCENT,
               transferType);
        if (java.awt.image.ColorModel.isLinearRGBspace(colorSpace)) {
            is_LinearRGB = true;
            if (maxBits <= 8) {
                lRGBprecision = 8;
                tosRGB8LUT = java.awt.image.ColorModel.getLinearRGB8TosRGB8LUT();
                fromsRGB8LUT8 = java.awt.image.ColorModel.getsRGB8ToLinearRGB8LUT();
            } else {
                lRGBprecision = 16;
                tosRGB8LUT = java.awt.image.ColorModel.getLinearRGB16TosRGB8LUT();
                fromsRGB8LUT16 = java.awt.image.ColorModel.getsRGB8ToLinearRGB16LUT();
            }
        } else if (!is_sRGB) {
            for (int i = 0; i < 3; i++) {
    ...
    public Object getDataElements(int rgb, Object pixel) {
        ...
        //DataBuffer.TYPE_USHORT and DataBuffer.TYPE_INT
        int intpixel[] = null;
        if (transferType == java.awt.image.DataBuffer.TYPE_INT &&
            pixel != null) {
            intpixel = (int[])pixel;
            intpixel[0] = 0;
        } else {
        ...
        java.awt.image.ColorModel defaultCM = java.awt.image.ColorModel.getRGBdefault();
     ...
     */
    final public java.awt.image.WritableRaster createCompatibleWritableRaster (int w,
                                                                               int h) {
        if ((w <= 0) || (h <= 0)) {
        ...
        if (pixel_bits > 16) {
            return java.awt.image.Raster.createPackedRaster(java.awt.image.DataBuffer.TYPE_INT,
                                             w,h,bandmasks,null);
        }
        else if (pixel_bits > 8) {
            return java.awt.image.Raster.createPackedRaster(java.awt.image.DataBuffer.TYPE_USHORT,
                                             w,h,bandmasks,null);
        }
        else {
            return java.awt.image.Raster.createPackedRaster(java.awt.image.DataBuffer.TYPE_BYTE,
                                             w,h,bandmasks,null);
        }
    }
    ...
    /**
      ...
      * not.
      * @param raster the {@link java.awt.image.Raster} object to test for compatibility
