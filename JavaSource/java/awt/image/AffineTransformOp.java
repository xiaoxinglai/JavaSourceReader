...
public class AffineTransformOp implements BufferedImageOp, RasterOp {
    ...
    public final java.awt.image.BufferedImage filter(java.awt.image.BufferedImage src, java.awt.image.BufferedImage dst) {
        ...
        java.awt.image.BufferedImage origDst = dst;
        ...
        if (dst == null) {
                ...
                dstCM.getColorSpace().getType())
            {
                    ...
                    srcCM.getTransparency() == Transparency.OPAQUE)
                {
                    ...
                    java.awt.image.ColorConvertOp ccop = new java.awt.image.ColorConvertOp(hints);
                    java.awt.image.BufferedImage tmpSrc = null;
                    int sw = src.getWidth();
                    int sh = src.getHeight();
                    if (dstCM.getTransparency() == Transparency.OPAQUE) {
                        tmpSrc = new java.awt.image.BufferedImage(sw, sh,
                                                  java.awt.image.BufferedImage.TYPE_INT_ARGB);
                    }
                    else {
                        java.awt.image.WritableRaster r =
                            dstCM.createCompatibleWritableRaster(sw, sh);
                        tmpSrc = new java.awt.image.BufferedImage(dstCM, r,
        ...
        if (interpolationType != TYPE_NEAREST_NEIGHBOR &&
            dst.getColorModel() instanceof java.awt.image.IndexColorModel) {
            dst = new java.awt.image.BufferedImage(dst.getWidth(), dst.getHeight(),
                                    java.awt.image.BufferedImage.TYPE_INT_ARGB);
        }
        ...
        if (needToConvert) {
            java.awt.image.ColorConvertOp ccop = new ColorConvertOp(hints);
    ...
    public java.awt.image.BufferedImage createCompatibleDestImage (java.awt.image.BufferedImage src,
        ...
        if (destCM == null) {
                 ...
                 cm.getTransparency() == Transparency.OPAQUE))
            {
                ...
                image = new java.awt.image.BufferedImage(cm,
