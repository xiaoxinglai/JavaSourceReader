 ...
 * the beginning of the {@link java.awt.image.DataBuffer} to the first pixel and must be
...
public class MultiPixelPackedSampleModel extends java.awt.image.SampleModel
{
    ...
    public MultiPixelPackedSampleModel(int dataType,
        ...
        this(dataType,w,h,
             numberOfBits,
            (w*numberOfBits+ java.awt.image.DataBuffer.getDataTypeSize(dataType)-1)/
                java.awt.image.DataBuffer.getDataTypeSize(dataType),
             0);
     ...
     *                  data described
     * @exception java.awt.image.RasterFormatException if the number of bits per pixel
    ...
    public MultiPixelPackedSampleModel(int dataType, int w, int h,
        ...
        if (pixelsPerDataElement*numberOfBits != dataElementSize) {
           throw new java.awt.image.RasterFormatException("MultiPixelPackedSampleModel " +
     ...
     * @return a {@link java.awt.image.SampleModel} with the specified width and height
    ...
    public int getTransferType() {
        if (pixelBitStride > 16)
            return java.awt.image.DataBuffer.TYPE_INT;
        else if (pixelBitStride > 8)
            return java.awt.image.DataBuffer.TYPE_USHORT;
        else
            return java.awt.image.DataBuffer.TYPE_BYTE;
    }
     ...
     * @exception java.awt.image.RasterFormatException if the number of bands requested
     * is not one.
     * @throws IllegalArgumentException if <code>w</code> or
     *         <code>h</code> is not greater than 0
     */
