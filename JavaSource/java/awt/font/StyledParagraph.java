...
final class StyledParagraph {
    ...
    static Map<? extends Attribute, ?>
        ...
        Object value = oldStyles.get(java.awt.font.TextAttribute.INPUT_METHOD_HIGHLIGHT);
    ...
    private static Object getGraphicOrFont(
        ...
        Object value = attributes.get(java.awt.font.TextAttribute.CHAR_REPLACEMENT);
        if (value != null) {
            return value;
        }
        value = attributes.get(java.awt.font.TextAttribute.FONT);
        if (value != null) {
            return value;
        }
