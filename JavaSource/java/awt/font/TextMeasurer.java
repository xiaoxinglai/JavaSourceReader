...
public final class TextMeasurer implements Cloneable {
    ...
    */
    ...
    private void initAll(AttributedCharacterIterator text) {
        ...
        // set paragraph attributes
        {
            ...
            if (haveFont) {
                ...
                java.awt.font.LineMetrics lm = defaultFont.getLineMetrics(fChars, charsStart, charsStart+1, fFrc);
                ...
                fBaseline = java.awt.font.TextLayout.getBaselineFromGraphic(graphic);
            ...
            fBaselineOffsets = java.awt.font.TextLine.getNormalizedOffsets(fBaselineOffsets, fBaseline);
        }
    ...
    private void generateComponents(int startingAt, int endingAt) {
        ...
        try {
            fComponents = java.awt.font.TextLine.getComponents(
    ...
    private java.awt.font.TextLine makeTextLineOnRange(int startPos, int limitPos) {
        ...
        return new java.awt.font.TextLine(fFrc,
                            components,
                            fBaselineOffsets,
                            fChars,
                            startPos,
    ...
    public float getAdvanceBetween(int start, int limit) {
        ...
        java.awt.font.TextLine line = makeTextLineOnRange(localStart, localLimit);
     ...
     *          the paragraph and the end of the paragraph.
     */
    public java.awt.font.TextLayout getLayout(int start, int limit) {

        int localStart = start - fStart;
        int localLimit = limit - fStart;

        ensureComponents(localStart, localLimit);
        java.awt.font.TextLine textLine = makeTextLineOnRange(localStart, localLimit);
