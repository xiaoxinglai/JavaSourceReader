...
package JavaSource.java.awt.font;
...
public final class TextLayout implements Cloneable {
    ...
    private java.awt.font.TextLine.TextLineMetrics lineMetrics = null;
    ...
    /**
     * Creates a <code>TextLayout</code> from a {@link java.awt.font.TextLine} and
     ...
     */
    TextLayout(java.awt.font.TextLine textLine,
               byte baseline,
    ...
    private void paragraphInit(byte aBaseline, CoreMetrics lm,
        ...
        baselineOffsets = java.awt.font.TextLine.getNormalizedOffsets(lm.baselineOffsets, baseline);
    ...
    private void fastInit(char[] chars, Font font,
        ...
        textLine = java.awt.font.TextLine.fastCreateTextLine(frc, chars, font, cm, attrs);
    }
    ...
    private void standardInit(AttributedCharacterIterator text, char[] chars, FontRenderContext frc) {
        ...
        // set paragraph attributes
        {
            ...
            boolean haveFont = java.awt.font.TextLine.advanceToFirstFont(text);

            if (haveFont) {
                Font defaultFont = java.awt.font.TextLine.getFontAtCurrentPos(text);
        ...
        textLine = java.awt.font.TextLine.standardCreateTextLine(frc, text, chars, baselineOffsets);
    }
    ...
    public TextLayout getJustifiedLayout(float justificationWidth) {
        ...
        java.awt.font.TextLine newLine = textLine.getJustifiedLine(justificationWidth, justifyRatio, 0, limit);
        if (newLine != null) {
