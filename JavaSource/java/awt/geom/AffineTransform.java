...
public class AffineTransform implements Cloneable, java.io.Serializable {
     ...
     * in <code>ptDst</code>.
     * If <code>ptDst</code> is <code>null</code>, a new {@link java.awt.geom.Point2D}
    ...
    public java.awt.geom.Point2D transform(java.awt.geom.Point2D ptSrc, java.awt.geom.Point2D ptDst) {
        if (ptDst == null) {
            if (ptSrc instanceof java.awt.geom.Point2D.Double) {
     ...
     * @since 1.2
     */
    public void transform(java.awt.geom.Point2D[] ptSrc, int srcOff,
                          java.awt.geom.Point2D[] ptDst, int dstOff,
                          int numPts) {
        int state = this.state;
        while (--numPts >= 0) {
            // Copy source coords into local variables in case src == dst
            java.awt.geom.Point2D src = ptSrc[srcOff++];
            double x = src.getX();
            double y = src.getY();
            java.awt.geom.Point2D dst = ptDst[dstOff++];
            if (dst == null) {
                if (src instanceof java.awt.geom.Point2D.Double) {
