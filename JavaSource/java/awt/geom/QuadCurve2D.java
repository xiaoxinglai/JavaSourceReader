...
public abstract class QuadCurve2D implements Shape, Cloneable {
    ...
    public static class Float extends QuadCurve2D implements Serializable {
        ...
        public java.awt.geom.Point2D getCtrlPt() {
            return new java.awt.geom.Point2D.Float(ctrlx, ctrly);
        }
    ...
    public static class Double extends QuadCurve2D implements Serializable {
         ...
         */
        public java.awt.geom.Point2D getCtrlPt() {
            return new java.awt.geom.Point2D.Double(ctrlx, ctrly);
        }
     ...
     * @since 1.2
     */
    public void setCurve(java.awt.geom.Point2D p1, java.awt.geom.Point2D cp, java.awt.geom.Point2D p2) {
    ...
    public static double getFlatnessSq(double coords[], int offset) {
        return java.awt.geom.Line2D.ptSegDistSq(coords[offset + 0], coords[offset + 1],
                                  coords[offset + 4], coords[offset + 5],
                                  coords[offset + 2], coords[offset + 3]);
    }
    ...
    public static double getFlatness(double coords[], int offset) {
        return java.awt.geom.Line2D.ptSegDist(coords[offset + 0], coords[offset + 1],
                                coords[offset + 4], coords[offset + 5],
                                coords[offset + 2], coords[offset + 3]);
    }
    ...
    public double getFlatnessSq() {
        return java.awt.geom.Line2D.ptSegDistSq(getX1(), getY1(),
                                  getX2(), getY2(),
                                  getCtrlX(), getCtrlY());
    }
