 ...
 * another {@link java.awt.geom.PathIterator} object.  Other {@link java.awt.Shape Shape}
...
public class FlatteningPathIterator implements java.awt.geom.PathIterator {
    ...
    java.awt.geom.PathIterator src;                   // The source iterator
     ...
     * iterated over.
     * @see java.awt.geom.PathIterator#WIND_EVEN_ODD
     * @see java.awt.geom.PathIterator#WIND_NON_ZERO
     */
    ...
    private void next(boolean doNext) {
        ...
        case SEG_CUBICTO:
            ...
            level = levels[levelIndex];
            while (level < limit) {
                if (java.awt.geom.CubicCurve2D.getFlatnessSq(hold, holdIndex) < squareflat) {
                    break;
                }
     ...
     *          returned.
     * @see java.awt.geom.PathIterator#SEG_MOVETO
     * @see java.awt.geom.PathIterator#SEG_LINETO
     * @see java.awt.geom.PathIterator#SEG_CLOSE
     */
