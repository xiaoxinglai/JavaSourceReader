...
package JavaSource.java.awt.dnd;
 ...
 * created by the {@link java.awt.dnd.DragSource} to notify
 ...
 * the user has chosen {@linkplain java.awt.dnd.DnDConstants#ACTION_MOVE the move action},
...
public class DragSourceContext
    ...
    public DragSourceContext(DragSourceContextPeer dscp,
                             java.awt.dnd.DragGestureEvent trigger, Cursor dragCursor,
        ...
        if (trigger.getDragAction() == java.awt.dnd.DnDConstants.ACTION_NONE) {
    ...
    public java.awt.dnd.DragSource getDragSource() { return trigger.getDragSource(); }
    ...
    public java.awt.dnd.DragGestureEvent getTrigger() { return trigger; }
    ...
    public void dragExit(DragSourceEvent dse) {
        ...
        updateCurrentCursor(java.awt.dnd.DnDConstants.ACTION_NONE, java.awt.dnd.DnDConstants.ACTION_NONE, DEFAULT);
    }
    ...
    protected synchronized void updateCurrentCursor(int sourceAct, int targetAct, int status) {
        ...
        switch (status) {
            default:
                targetAct = java.awt.dnd.DnDConstants.ACTION_NONE;
            case ENTER:
            case OVER:
            case CHANGED:
                int    ra = sourceAct & targetAct;

                if (ra == java.awt.dnd.DnDConstants.ACTION_NONE) { // no drop possible
                    if ((sourceAct & java.awt.dnd.DnDConstants.ACTION_LINK) == java.awt.dnd.DnDConstants.ACTION_LINK)
                        c = java.awt.dnd.DragSource.DefaultLinkNoDrop;
                    else if ((sourceAct & java.awt.dnd.DnDConstants.ACTION_MOVE) == java.awt.dnd.DnDConstants.ACTION_MOVE)
                        c = java.awt.dnd.DragSource.DefaultMoveNoDrop;
                    else
                        c = java.awt.dnd.DragSource.DefaultCopyNoDrop;
                } else { // drop possible
                    if ((ra & java.awt.dnd.DnDConstants.ACTION_LINK) == java.awt.dnd.DnDConstants.ACTION_LINK)
                        c = java.awt.dnd.DragSource.DefaultLinkDrop;
                    else if ((ra & java.awt.dnd.DnDConstants.ACTION_MOVE) == DnDConstants.ACTION_MOVE)
