...
class DnDEventMulticaster extends AWTEventMulticaster
    implements java.awt.dnd.DragSourceListener, DragSourceMotionListener {
    ...
    public void dragEnter(DragSourceDragEvent dsde) {
        ((java.awt.dnd.DragSourceListener)a).dragEnter(dsde);
        ((java.awt.dnd.DragSourceListener)b).dragEnter(dsde);
    }
    ...
    public void dragOver(DragSourceDragEvent dsde) {
        ((java.awt.dnd.DragSourceListener)a).dragOver(dsde);
        ((java.awt.dnd.DragSourceListener)b).dragOver(dsde);
    }
    ...
    public void dropActionChanged(DragSourceDragEvent dsde) {
        ((java.awt.dnd.DragSourceListener)a).dropActionChanged(dsde);
        ((java.awt.dnd.DragSourceListener)b).dropActionChanged(dsde);
    }
    ...
    public void dragExit(DragSourceEvent dse) {
        ((java.awt.dnd.DragSourceListener)a).dragExit(dse);
        ((java.awt.dnd.DragSourceListener)b).dragExit(dse);
    }
    ...
    public void dragDropEnd(DragSourceDropEvent dsde) {
        ((java.awt.dnd.DragSourceListener)a).dragDropEnd(dsde);
        ((java.awt.dnd.DragSourceListener)b).dragDropEnd(dsde);
    }
     ...
     */
    public static java.awt.dnd.DragSourceListener add(java.awt.dnd.DragSourceListener a,
                                                      java.awt.dnd.DragSourceListener b) {
        return (java.awt.dnd.DragSourceListener)addInternal(a, b);
    }
     ...
     */
    public static java.awt.dnd.DragSourceListener remove(java.awt.dnd.DragSourceListener l,
                                                         java.awt.dnd.DragSourceListener oldl) {
