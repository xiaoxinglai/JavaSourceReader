...
public class DragSourceDropEvent extends java.awt.dnd.DragSourceEvent {
     ...
     *
     * @see java.awt.dnd.DragSourceEvent#getLocation
     */

    public DragSourceDropEvent(java.awt.dnd.DragSourceContext dsc, int action, boolean success) {
        super(dsc);
     ...
     * @since 1.4
     */
    public DragSourceDropEvent(java.awt.dnd.DragSourceContext dsc, int action,
