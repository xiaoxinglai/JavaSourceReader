...
public class DropTargetDropEvent extends DropTargetEvent {
    ...
    public DropTargetDropEvent(java.awt.dnd.DropTargetContext dtc, Point cursorLocn, int dropAction, int srcActions)  {
        super(dtc);

        if (cursorLocn == null) throw new NullPointerException("cursorLocn");

        if (dropAction != java.awt.dnd.DnDConstants.ACTION_NONE &&
            dropAction != java.awt.dnd.DnDConstants.ACTION_COPY &&
            dropAction != java.awt.dnd.DnDConstants.ACTION_MOVE &&
            dropAction != java.awt.dnd.DnDConstants.ACTION_LINK
        ) throw new IllegalArgumentException("dropAction = " + dropAction);

        if ((srcActions & ~(java.awt.dnd.DnDConstants.ACTION_COPY_OR_MOVE | java.awt.dnd.DnDConstants.ACTION_LINK)) != 0) throw new IllegalArgumentException("srcActions");
     ...
     * @serial
     */
    private int                 actions    = java.awt.dnd.DnDConstants.ACTION_NONE;
