...
package JavaSource.java.awt.print;
...
public abstract class PrinterJob {
 ...
 /* Public Methods */
     ...
     * <code>PrinterJob</code> are rendered by the {@link java.awt.print.Printable}
     * object, <code>painter</code>.  The {@link java.awt.print.PageFormat} for each page
     ...
     *                   be printed
     */
    public abstract void setPrintable(java.awt.print.Printable painter, java.awt.print.PageFormat format);
     ...
     *
     */
    public java.awt.print.PageFormat pageDialog(PrintRequestAttributeSet attributes)
        throws HeadlessException {
    ...
    public java.awt.print.PageFormat defaultPage() {
        return defaultPage(new java.awt.print.PageFormat());
    }
     ...
     * @since 1.6
     */
    public java.awt.print.PageFormat getPageFormat(PrintRequestAttributeSet attributes) {

        PrintService service = getPrintService();
        java.awt.print.PageFormat pf = defaultPage();
        ...
        if (orientReq != null &&
            ...
            if (orientReq.equals(OrientationRequested.REVERSE_LANDSCAPE)) {
                orient = java.awt.print.PageFormat.REVERSE_LANDSCAPE;
            } else if (orientReq.equals(OrientationRequested.LANDSCAPE)) {
                orient = java.awt.print.PageFormat.LANDSCAPE;
            } else {
                orient = java.awt.print.PageFormat.PORTRAIT;
            }
     ...
     */
    public abstract java.awt.print.PageFormat validatePage(PageFormat page);
   ...
   /**
     ...
     * See {@link java.awt.print.Printable} for an explanation of the required
